...
export default {
	...
	handleFileSelect: function (e) {
		...
		/*var curr_file = files[0];
		curr_file.file_contents = e.target.result;
		console.log(curr_file);*/
		//this.submissionData.files.push(temp);
		file_contents = e.target.result;
		//console.log(files[0].name);
		//this.submissionData.contents.push(file_contents);
		var file = files[0];
		file.file_contents = file_contents;
		parent.submissionData.files.push(file);
		parent.submissionData.title = files[0].name;
		//console.log(parent.submissionData);
	    };
